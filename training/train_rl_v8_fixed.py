"""
T08 v8 Fixed - PPO Training with Regime Features + Double Spread Fix
Env: V8 (Signal + Auto TP/SL + Time + Regime).
Train: 2022+2023. Test: 2024.

Usage :
  python training/train_rl_v8_fixed.py
"""
...
def train():
    print("=" * 60)
    print("T08 v8 Fixed - PPO Training (Double Spread Fixed)")
    print("=" * 60, flush=True)
    ...
    print("  Env V8 Fixed OK", flush=True)
