"""
T08 v8 – PPO avec Features de Régime (ADX + ATR Ratio)
Env: V8 (Signal + Auto TP/SL + Time + Regime).
Train: 2022+2023. Test: 2024.

Usage :
  python training/train_rl_v8.py
"""
...
MODEL_DIR = PROJECT_ROOT / "models" / "v8"
...
def train():
    print("=" * 60)
    print("T08 v8 - PPO Training (2022-2023) with Regime Features")
    print("=" * 60, flush=True)
