"""
T08 v5d – RL Signal + TP facile / SL large
TP=0.15% (facile à atteindre), SL=0.3% (loin)
Le modèle doit juste être bon à >34% pour être profitable.

Usage :
  python training/train_rl_v5d.py
"""
...
MODEL_DIR = PROJECT_ROOT / "models" / "v5d"
...
RL_CONFIG = {
    ...
    "window_size": 30,
    "spread": 0.00015,
    "take_profit_pct": 0.0015,    # 0.15% TP (15 pips) - FACILE
    "stop_loss_pct": 0.003,       # 0.3% SL (30 pips) - LOIN
    "max_hold": 32,               # 8h max hold
    "cooldown": 4,
    "net_arch": [128, 64],
}
...
def train():
    print("=" * 60)
    print("T08 v5d - RL Signal + Easy TP / Wide SL")
    print("=" * 60, flush=True)
